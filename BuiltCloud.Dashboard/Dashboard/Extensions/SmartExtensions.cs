...
using System;
using BuiltCloud.Dashboard.Configuration;
...
namespace BuiltCloud.Dashboard.Extensions
{
    ...
    public static class SmartExtensions
    {
        ...
        /// <summary>
        /// Checks if the current hosting environment name is <see cref="F:BuiltCloud.Dashboard.Configuration.EnvironmentName.Demo" />.
        /// </summary>
        /// <param name="hostingEnvironment">A string value representing the hosting environment.</param>
        /// <returns><c>True</c> if the environment name is <see cref="F:BuiltCloud.Dashboard.Configuration.EnvironmentName.Demo" />, otherwise <c>false</c>.</returns>
